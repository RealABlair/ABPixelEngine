...
namespace ABSoftware.ABPixelEngine
{
    public static class Native
    {
        ...
        public static readonly IntPtr IDI_HAND = (IntPtr)32513;
        public static readonly IntPtr IDI_QUESTION = (IntPtr)32514;
        public static readonly IntPtr IDI_EXCLAMATION = (IntPtr)32515;
        public static readonly IntPtr IDI_ASTERISK = (IntPtr)32516;
        public static readonly IntPtr IDI_WINLOGO = (IntPtr)32517;
        public static readonly IntPtr IDI_SHIELD = (IntPtr)32518;

        static readonly ABDictionary<IDC, IntPtr> cursors = new ABDictionary<IDC, IntPtr>();

        public static IntPtr GetCursor(IDC cursorId)
        {
            if (cursors.TryGet(cursorId, out IntPtr handle))
                return handle;

            handle = LoadCursor(IntPtr.Zero, (IntPtr)cursorId);
            cursors[cursorId] = handle;
